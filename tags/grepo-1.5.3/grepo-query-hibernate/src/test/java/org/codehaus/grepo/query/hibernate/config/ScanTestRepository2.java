...
/**
 * This repository will be generated with bean name 'testRepository2CustomName'.
 *
 * @author dguggi
 */
@Repository("scanTestRepository2CustomName")
public interface ScanTestRepository2 extends ReadWriteHibernateRepository<TestEntity, Long> {
    /**
