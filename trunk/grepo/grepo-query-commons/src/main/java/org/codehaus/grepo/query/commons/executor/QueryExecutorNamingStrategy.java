...
/**
 * Responsible for resolving the name of an {@link QueryExecutor} based on the {@link QueryMethodParameterInfo}
 * instance.
 *
 * @author dguggi
 */
public interface QueryExecutorNamingStrategy {
     ...
     */
    String getExecutorName(QueryMethodParameterInfo qmpi);
}
