 ...
 */
public class HibernateRepositoryImpl<T> extends GenericRepositorySupport<T> implements HibernateRepository<T> {

    /** The logger for this class. */
    private static final Log LOG = LogFactory.getLog(HibernateRepositoryImpl.class);
     ...
     */
    public HibernateRepositoryImpl(Class<T> entityType) {
        super(entityType);
    }
