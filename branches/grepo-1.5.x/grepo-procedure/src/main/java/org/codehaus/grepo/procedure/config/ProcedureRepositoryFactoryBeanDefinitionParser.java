 ...
 * @author dguggi
 */
public class ProcedureRepositoryFactoryBeanDefinitionParser extends GenericRepositoryFactoryBeanDefinitionParser {
    /** Default constructor. */
    public ProcedureRepositoryFactoryBeanDefinitionParser() {
