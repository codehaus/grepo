...
public class StatisticsCollectionUtils {
     ...
     * @return Returns a sorted list of {@link StatisticsEntry} objects.
     */
    public static List<StatisticsEntry> getStatisticEntries(StatisticsCollectionEntry entry,
            StatisticsEntryComparator comparator) {
        List<StatisticsEntry> list = entry.getStatisticsEntriesList();
        Collections.sort(list, comparator);
        return list;
    }
}
