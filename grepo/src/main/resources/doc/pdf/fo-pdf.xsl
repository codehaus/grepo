            ...
            <fo:table table-layout="fixed" width="175mm">
                ...
                <fo:table-body>
                    ...
                    <fo:table-row>
                        <fo:table-cell text-align="center">
                            <fo:block>
                                <fo:external-graphic src="url(target/doc/pdf/resorces/images/grepo-logo-big-200x40.png)"
                                    width="70mm" height="auto" content-width="scale-to-fit" content-height="scale-to-fit" />
                            </fo:block>
                            <fo:block font-size="12pt" padding="10mm">
